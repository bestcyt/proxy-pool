...
class CreateProxySpiderAbleIpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('proxy_spider_able_ips', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('proxy_spider_able_ips');
    }
}
